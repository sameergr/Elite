...
<head>
	...
	<script type="text/javascript">
		...
		function submitData(){
	        ...
	        $.ajax({
	            type: "POST",
	            url: "${pageContext.request.contextPath}/rest/play/saveUserQueAns",
...
<div class="container" id="main-content">
		<section>
			<div class="form-blk" align="left" >
				<h1>${levelId} - ${pageContext.request.contextPath}/rest/play/quiz/${levelId}</h1>
...
<script language="javascript">
    ...
    <script>
            ...
            <form:form method="post"  modelAttribute="saveUserQueAns" action="${pageContext.request.contextPath}/guest-users/saveUserQueAns">
				LevelId<input type="text" name="levelId" value="${levelId}" id="levelId">
				SeriesId<input type="text" name="seriesId" value="${seriesId}" id="seriesId">
				UserId<input type="text" name="userId" value="${userId}" id="userId">
				QuesId<input type="text" name="result" value=""  id="result">
				Question Level Time<input type="text" name="questionLevelTime" value="${questionLevelTime}" id="questionLevelTime">
				NoOfQuestion<input type="text" name="noq" value="${fn:length(level.questions)}" id="noq">
				<span style="color:red;font-weight: bolder;" id="countdown"></span>
		                    
					<div class="form-blk" >
						<tr>
							<td>Question :<input type="text" name="questionId" value="" id="questionId"></td>
							<div id="ques"></div>
						</tr></br>
						<tr>
	             ...
	             <input id="finish" type="button" value="Finish" onclick="createJsonData(),submitData();" >
			 </form:form>
