...
<body>
	<!-- <div class="container" id="header" id="content">
			...
			<div class="col spn_1_12"> -->
				<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					...
					<div class="group compy-blk">
						...
						<div class="title"><a href="${pageContext.request.contextPath}/admin/organization?key=${user.userProfile.organization.id}">${user.userProfile.organization.name}</a></div>
					...
					<div class="submenu-links">
						<ul>
							<c:forEach var="oragnizations" varStatus="loop" items="${userMemberOragnizations}">
								<a href="${pageContext.request.contextPath}/admin/organization?key=${oragnizations.organization.id}"><li>${oragnizations.organization.name}</li></a>
		...
		<div class="container" id="header" id="content">
			...
			<div class="logo">
					<a href="${pageContext.request.contextPath}/admin/signOut">
			...
			<c:if test="${image == null}">
				<div class="logo">
					<a href="${pageContext.request.contextPath}/admin/signOut">Admin</a>
				</div>
			</c:if>
			</div>
					...
					<li class="account-wrp">
		                ...
		                <div class="account-blk">
		                  	<div class="user-blk">
			                    ...
			                    <div>Hi&nbsp; <span name="fname" value="${userfullname}">${userfullname}</span></div><!-- .userProfile.firstName -->
		                	</div>
			                <ul class="user-tabs">
			                    <li>
			                        <a href="${pageContext.request.contextPath}/admin/editProfile">Complete your profile</a>
			                    </li>
			                    <li>
	                      	...
	                      	<div class="signout-blk">
	                        	...
	                        	<a href="${pageContext.request.contextPath}/admin/signOut">Sign out</a>
	                      	</div>
		                </div>
					</li>
					<li>
...
<!--  			<?jsp $currentPage = substr($_SERVER["SCRIPT_NAME"],strrpos($_SERVER["SCRIPT_NAME"],"/")+1);if($currentPage != 'dashboard.jsp'){ ?> -->
				...
				<ul class="dashboard-menu">
					<li>
						<div class="db-blk">
							<a href="${pageContext.request.contextPath}/admin/expertRecommendation">
					...
					<li class="active">
						<div class="db-blk">
									<a href="${pageContext.request.contextPath}/admin/mysubscription">
					...
					<li>
						<div class="db-blk">
							<a href="${pageContext.request.contextPath}/admin/customizeDashboard">
					...
					<li>
						<div class="db-blk">
							<a href="${pageContext.request.contextPath}/admin/alertNotification">
					...
					<li>
						<div class="db-blk">
							<a href="${pageContext.request.contextPath}/admin/appCenter">
					...
					<li>
						<div class="db-blk">
							<a href="${pageContext.request.contextPath}/admin/followFriend">
					...
					<li>
						<div class="db-blk">
							<a href="${pageContext.request.contextPath}/admin/testCenter">
								<div class="testcenter-img"></div>
