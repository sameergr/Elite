...
<body>
	<!-- <div class="container" id="header" id="content">
			...
			<div class="col spn_1_12"> -->
				<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					...
					<div class="group compy-blk">
						...
						<div class="title"><a href="${pageContext.request.contextPath}/site/organization?key=${user.userProfile.organization.id}">${user.userProfile.organization.name}</a></div>
					...
					<div class="submenu-links">
						<ul>
							<c:forEach var="oragnizations" varStatus="loop" items="${userMemberOragnizations}">
								<a href="${pageContext.request.contextPath}/site/organization?key=${oragnizations.organization.id}"><li>${oragnizations.organization.name}</li></a>
		...
		<div class="container" id="header" id="content">
			...
			<div class="logo">
					<a href="${pageContext.request.contextPath}/site/signOut">
			...
			<c:if test="${image == null}">
				<div class="logo">
					<a href="${pageContext.request.contextPath}/site/signOut">Online Exam</a>
				</div>
			</c:if>
			</div>
					...
					<li class="account-wrp">
		                ...
		                <div class="account-blk">
		                  	<div class="user-blk">
			                    ...
			                    <div>Hi&nbsp; <span name="fname" value="${user.userProfile.firstName}">${user.userProfile.firstName}</span></div><!-- .userProfile.firstName -->
		                	</div>
			                <ul class="user-tabs">
			                    <li>
